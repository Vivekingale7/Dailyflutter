...
void main() async {
  ...
  Player player1 =
      Player(name: "Virat Kohli", jerNo: 18, runs: 27000, avg: 56.86);
  await insertPlayerData(player1);

  Player player2 =
      Player(name: "Shubhman Gill", jerNo: 77, runs: 3245, avg: 66.32);
  await insertPlayerData(player2);

  Player player3 =
      Player(name: "Rishbh Pant", jerNo: 17, runs: 4500, avg: 56.86);
